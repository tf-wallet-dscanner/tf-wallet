...
function EstimateGas() {
  ...
  return (
    <Box className="estimate-gas">
        ...
        <div className="modal-box">
          <h3 className="flex justify-between">
            ...
            <label htmlFor="estimate-gas__modal">
              <GrFormClose className="text-white text-2xl cursor-pointer" />
            </label>
          </h3>
      ...
      <Box className="grid grid-cols-2 py-2 items-center">
        <Box>
          <Typography className="font-bold text-sm">가스</Typography>
      ...
      <Box className="grid grid-cols-2 py-2 items-center">
        <Box>
          <Typography className="font-bold text-sm">합계</Typography>
          <Typography className="!text-gray-500 italic text-xs">
            &nbsp;(금액 + 가스 요금)
          </Typography>
        </Box>
